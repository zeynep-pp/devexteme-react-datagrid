...
} from "../../__internal/ui/scroll_view/m_scrollable.device";
...
export const ListBase = CollectionWidget.inherit({
    ...
    _defaultOptionsRules: function() {
        ...
        return this.callBase().concat(deviceDependentOptions(), [{
            ...
            device: function(device) {
                return !nativeScrolling && !devices.isSimulator() && "desktop" === devices.real().deviceType && "generic" === device.platform
            },
            options: {
    ...
    _attachGroupCollapseEvent: function() {
        ...
        if (collapsibleGroups) {
            eventsEngine.on($element, eventName, ".dx-list-group-header", function(e) {
