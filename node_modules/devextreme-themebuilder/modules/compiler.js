...
class Compiler {
    constructor() {
        ...
        this.sassCompile = (source, items, options, compile) => __awaiter(this, void 0, void 0, function* () {
            this.changedVariables = {};
            if (items) {
                this.userItems = items.reduce((acc, item) => {
                    acc[item.key] = item;
                    return acc;
                }, {});
            }
        ...
        // eslint-disable-next-line spellcheck/spell-checker
        this.canonicalize = (url) => (url.includes('tb_index') ? new URL(`db:${url}`) : null);
        this.load = () => ({
            contents: this.indexFileContent,
            syntax: 'scss',
        });
        this.getCustomVar = (values) => {
            ...
            if (customerVariable) {
                result = (0, parse_value_1.parseString)(customerVariable.value);
            }
            return result;
        };
        this.collector = (maps) => {
