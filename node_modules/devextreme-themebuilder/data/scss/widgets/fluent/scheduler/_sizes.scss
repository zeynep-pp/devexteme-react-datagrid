...
$fluent-scheduler-dropdown-day-margin: null !default;
...
$fluent-scheduler-header-height: $fluent-toolbar-height + 2px !default;
...
@if $size == "default" {
  ...
  $fluent-scheduler-dropdown-day-margin: 5px !default;
...
@else if $size == "compact" {
  ...
  $fluent-scheduler-dropdown-day-margin: 2px !default;
