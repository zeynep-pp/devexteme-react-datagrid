$texteditor-color: getCustomVar(("$texteditor-color")) !default;
$texteditor-placeholder-color: getCustomVar(("$texteditor-placeholder-color")) !default;
$texteditor-outlined-bg: getCustomVar(("$texteditor-outlined-bg")) !default;
$texteditor-outlined-bg-hover: getCustomVar(("$texteditor-outlined-bg-hover")) !default;
$texteditor-outlined-bg-focused: getCustomVar(("$texteditor-outlined-bg-focused")) !default;
$texteditor-filled-bg: getCustomVar(("$texteditor-filled-bg")) !default;
$texteditor-underlined-bg: getCustomVar(("$texteditor-underlined-bg")) !default;
$texteditor-underlined-bg-hover: getCustomVar(("$texteditor-underlined-bg-hover")) !default;
$texteditor-underlined-bg-focused: getCustomVar(("$texteditor-underlined-bg-focused")) !default;
$texteditor-border-color: getCustomVar(("$texteditor-border-color")) !default;
$texteditor-border-bottom-color: getCustomVar(("$texteditor-border-bottom-color")) !default;
$texteditor-indicator-border-color: getCustomVar(("$texteditor-indicator-border-color")) !default;
$texteditor-filled-bg-hover: getCustomVar(("$texteditor-filled-bg-hover")) !default;
$texteditor-filled-bg-focused: getCustomVar(("$texteditor-filled-bg-focused")) !default;
...
"$texteditor-color": $texteditor-color,
"$texteditor-placeholder-color": $texteditor-placeholder-color,
"$texteditor-outlined-bg": $texteditor-outlined-bg,
"$texteditor-outlined-bg-hover": $texteditor-outlined-bg-hover,
"$texteditor-outlined-bg-focused": $texteditor-outlined-bg-focused,
"$texteditor-filled-bg": $texteditor-filled-bg,
"$texteditor-underlined-bg": $texteditor-underlined-bg,
"$texteditor-underlined-bg-hover": $texteditor-underlined-bg-hover,
"$texteditor-underlined-bg-focused": $texteditor-underlined-bg-focused,
"$texteditor-border-color": $texteditor-border-color,
"$texteditor-border-bottom-color": $texteditor-border-bottom-color,
"$texteditor-indicator-border-color": $texteditor-indicator-border-color,
"$texteditor-filled-bg-hover": $texteditor-filled-bg-hover,
"$texteditor-filled-bg-focused": $texteditor-filled-bg-focused,
));
