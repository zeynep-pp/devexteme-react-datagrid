$tabs-tab-color: getCustomVar(("$tabs-tab-color")) !default;
$tabs-tab-selected-color: getCustomVar(("$tabs-tab-selected-color")) !default;
$tabs-tab-bg: getCustomVar(("$tabs-tab-bg")) !default;
$tabs-tab-selected-bg: getCustomVar(("$tabs-tab-selected-bg")) !default;
$tabs-border-color: getCustomVar(("$tabs-border-color")) !default;
$tabs-focused-border-color: getCustomVar(("$tabs-focused-border-color")) !default;
$tabs-tab-hover-bg: getCustomVar(("$tabs-tab-hover-bg")) !default;
...
"$tabs-tab-color": $tabs-tab-color,
"$tabs-tab-selected-color": $tabs-tab-selected-color,
"$tabs-tab-bg": $tabs-tab-bg,
"$tabs-tab-selected-bg": $tabs-tab-selected-bg,
"$tabs-border-color": $tabs-border-color,
"$tabs-focused-border-color": $tabs-focused-border-color,
"$tabs-tab-hover-bg": $tabs-tab-hover-bg,
));
