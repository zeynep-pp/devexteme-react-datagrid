...
function Product() {
  ...
  useEffect(() => {
    // Fetch initial data for counterparties
    axios.get('/api/counterparties') // Replace with your actual endpoint
      .then(response => {
  ...
  const fetchDetails = (counterpartyId) => {
    axios.get(`/api/counterparties/${counterpartyId}/details`) // Replace with your actual endpoint
      .then(response => {
        setDetailsItems(response.data);
      })
      .catch(error => {
        ...
        {showDetailsFor !== null && (
          <div className="details-container">
            ...
            <div className="details-table-container">
              {renderDetailsTable(detailsItems)}
              <button className="add-details-button" onClick={() => openModal(counterparties.find(c => c.id === showDetailsFor))}>
                Add Details
              </button>
            </div>
          </div>
